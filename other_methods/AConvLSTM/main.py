...
class Train():
    def __init__(self, args):
        ...
        self.net = Model.net(3, args.conv_sensor, args.window_size*args.time_denpen_len, 32, 32, args.num_class)
...
if __name__ == '__main__':
    ...
    for datasub in range(1,5):
        ...
        for i in range(30):
            args.save_name = 'A_Conv_LSTM_RUL_datasub{}_{}'.format(datasub, i)
            train = Train(args)
            train.Train_model()
    ...
    for i in range(30):
        args.save_name = 'A_Conv_LSTM_HAR_{}'.format(i)
        train = Train(args)
        train.Train_model()
        print(args.save_name)
    ...
    for num_subject in range(10):
        ...
        for i in range(3):
            args.save_name = 'A_Conv_LSTM_{}_sub{}_{}'.format('ISRUC',num_subject, i)
            train = Train(args)
            train.Train_model()
            print(args.save_name)
