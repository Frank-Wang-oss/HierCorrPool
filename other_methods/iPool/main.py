...
class Train():
    def __init__(self, args):
        ...
        self.net = Model.iPool(input_dimension=args.window_size,
...
if __name__ == '__main__':
    ...
    for datasub in [4]:
        ...
        for i in range(30):
            args.save_name = 'iPool_RUL_datasub{}_{}'.format(datasub, i)
            train = Train(args)
            train.Train_model()
    ...
    for i in range(30):
        args.save_name = 'iPool_HAR_{}'.format(i)
        train = Train(args)
        train.Train_model()
        print(args.save_name)
    ...
    for num_subject in range(10):
        ...
        for i in range(3):
            args.save_name = 'iPool_{}_sub{}_{}'.format('ISRUC',num_subject, i)
            train = Train(args)
            train.Train_model()
            print(args.save_name)