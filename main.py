...
class Train():
    def __init__(self, args):
        self.args = args
        if args.dataset == 'RUL':
            self.train, self.valid, self.test = data_loader_RUL.data_generator(args,'D://PhD_in_Sg/research_related/datasets/RUL',
        ...
        self.net = Model_Graph.Graph_Classification(input_dimension=args.window_size,
